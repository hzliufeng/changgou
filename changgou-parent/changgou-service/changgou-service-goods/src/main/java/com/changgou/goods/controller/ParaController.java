...
public class ParaController {
    ...
    public Result<List<Para>> findParasByCategoryId(@PathVariable("id") Integer categoryId){
        return new Result<>(true,StatusCode.OK,"查询成功",paraService.findParasByCategoryId(categoryId));
    }
    /***
     * Para分页条件搜索实现
     * @param para
