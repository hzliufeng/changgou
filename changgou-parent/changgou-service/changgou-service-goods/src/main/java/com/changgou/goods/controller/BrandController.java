...
public class BrandController {
    ...
    public Result<List<Brand>> findBrandsByCategoryId(@PathVariable("id") Integer categoryId){
        return new Result<>(true,StatusCode.OK,"查询成功",brandService.findBrandsByCategoryId(categoryId));
    }
    /***
     * Brand分页条件搜索实现
     * @param brand
