...
public class SpecController {
    ...
    public Result<List<Spec>> findSpecsByCategoryId(@PathVariable("id") Integer categoryId){
        return new Result<>(true,StatusCode.OK,"查询成功",specService.findSpecsByCategoryId(categoryId));
    }
    /***
     * Spec分页条件搜索实现
     * @param spec
